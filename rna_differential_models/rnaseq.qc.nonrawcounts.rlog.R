...
#take the rlog transform of the data 
...
for(i in c(1,2,3,4,5,6,7,8,9))
{
  ...
  write.table(tab,file=paste("rna_differential_limma_rlog",comparisons[i],".tsv",sep=""),quote=TRUE,sep='\t',row.names = FALSE)
}
...
for(i in c(1,2,3,4,5,6,7,8,9))
{
  ...
  write.table(tab,file=paste("rna_differential_limma_exp_rlog",comparisons[i],".tsv",sep=""),quote=TRUE,sep='\t',row.names = FALSE)
}
