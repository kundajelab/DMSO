...
chip_fc=read.table("r_chip_fc.csv",header=TRUE,sep='\t')
...
chip_fc_rownames=chip_fc$GREAT.Gene.Map
chip_fc$GREAT.Gene.Map=NULL
chip_fc=as.matrix(chip_fc)
png('CHIPSEQ_FOLDCHANGE_from_intersection.png',height=17,width=10,units='in',res=600)
heatmap.2(chip_fc,
          cexCol=1,
          col=redgreen(30),
          Rowv=FALSE,
          ...
          margins=c(15,15),
          keysize = 0.5,
          main="CHIPSEQ FOLD CHANGE from 3-way intersection")
dev.off() 
