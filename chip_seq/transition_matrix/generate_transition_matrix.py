...
def get_transition_matrix(h3k27ac,h3k4me3,h3k27me3,diff_dict,cluster_specific=False,cluster_index=None): 
    ...
    for line in chromsizes:
        ...
        if cluster_specific==True:
            cluster_atac=BedTool("/srv/scratch/annashch/dmso/dp_gp/dpgp_diff_peaks_fold/"+str(cluster_index)+".bed")
            intervals=intervals.intersect(cluster_atac)
...
get_transition_matrix(h3k27ac,h3k4me3,h3k27me3,diff_dict) 
for cluster_index in range(1,7):
    get_transition_matrix(h3k27ac,h3k4me3,h3k27me3,diff_dict,cluster_specific=True,cluster_index=cluster_index) 
