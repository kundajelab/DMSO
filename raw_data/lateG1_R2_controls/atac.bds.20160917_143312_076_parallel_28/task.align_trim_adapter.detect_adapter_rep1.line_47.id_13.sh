...
# SYS command. line 51
 ...
 python3 $(which detect_adapter.py) /srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R2_controls/H9_Fucci_LateG1_R2_C1_S39_L005_R2_001.fastq.gz > /srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R2_controls/out/qc/rep1/H9_Fucci_LateG1_R2_C1_S39_L005_R2_001.adapter.txt
