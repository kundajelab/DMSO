...
# SYS command. line 177
 ...
 zcat /srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R1_controls/out/align/pseudo_reps/rep1/pr1/H9_Fucci_earlyG1_C1_S23_L004_R1_001.trim.PE2SE.nodup.pr1.tagAlign.gz | awk -F $'\t' 'BEGIN {OFS = FS}{ if ($6 == "+") {$2 = $2 + 4} else if ($6 == "-") {$3 = $3 - 5} print $0}' | gzip -c > /srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R1_controls/out/align/pseudo_reps/rep1/pr1/H9_Fucci_earlyG1_C1_S23_L004_R1_001.trim.PE2SE.nodup.pr1.tn5.tagAlign.gz
