...
# SYS command. line 51
 ...
 python3 $(which detect_adapter.py) /srv/gsfs0/projects/kundaje/users/annashch/dmso/SG2M_R1_controls/H9_Fucci_SG2M_C2_S32_L004_R2_001.fastq.gz > /srv/gsfs0/projects/kundaje/users/annashch/dmso/SG2M_R1_controls/out/qc/rep2/H9_Fucci_SG2M_C2_S32_L004_R2_001.adapter.txt
