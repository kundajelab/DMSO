...
# SYS command. line 368
 ...
 if [ -f "${MARKDUP}" ]; then \
			java -Xmx4G -jar ${MARKDUP} \
				INPUT="/srv/gsfs0/projects/kundaje/users/annashch/dmso/SG2M_R1_controls/out/align/rep2/H9_Fucci_SG2M_C2_S32_L004_R1_001.trim.PE2SE.filt.bam" OUTPUT="/srv/gsfs0/projects/kundaje/users/annashch/dmso/SG2M_R1_controls/out/align/rep2/H9_Fucci_SG2M_C2_S32_L004_R1_001.trim.PE2SE.dupmark.bam" \
				METRICS_FILE="/srv/gsfs0/projects/kundaje/users/annashch/dmso/SG2M_R1_controls/out/qc/rep2/H9_Fucci_SG2M_C2_S32_L004_R1_001.trim.PE2SE.dup.qc" VALIDATION_STRINGENCY=LENIENT \
