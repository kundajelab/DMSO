...
# SYS command. line 177
 ...
 zcat /srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R2_controls/out/align/pseudo_reps/rep2/pr1/H9_Fucci_earlyG1_R2_C2_S36_L005_R1_001.trim.PE2SE.nodup.pr1.tagAlign.gz | awk -F $'\t' 'BEGIN {OFS = FS}{ if ($6 == "+") {$2 = $2 + 4} else if ($6 == "-") {$3 = $3 - 5} print $0}' | gzip -c > /srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R2_controls/out/align/pseudo_reps/rep2/pr1/H9_Fucci_earlyG1_R2_C2_S36_L005_R1_001.trim.PE2SE.nodup.pr1.tn5.tagAlign.gz
