...
# SYS command. line 115
 ...
 zcat /srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R2_controls/out/align/rep2/H9_Fucci_earlyG1_R2_C2_S36_L005_R1_001.trim.PE2SE.nodup.bedpe.gz | \
			grep -v "chrM" | shuf -n 25000000 | \
			awk 'BEGIN{OFS="\t"}{print $1,$2,$3,"N","1000",$9}' | gzip -c > /srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R2_controls/out/align/rep2/H9_Fucci_earlyG1_R2_C2_S36_L005_R1_001.trim.PE2SE.nodup.25M.tagAlign.gz
