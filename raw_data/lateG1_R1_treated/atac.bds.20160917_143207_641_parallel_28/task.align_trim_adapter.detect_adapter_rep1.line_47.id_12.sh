...
# SYS command. line 51
 ...
 python3 $(which detect_adapter.py) /srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R1_treated/H9_Fucci_LateG1_D1_S29_L004_R2_001.fastq.gz > /srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R1_treated/out/qc/rep1/H9_Fucci_LateG1_D1_S29_L004_R2_001.adapter.txt
