...
# SYS command. line 209
 ...
 echo -e "Nt\tN1	N2	""Np\tconservative_set\toptimal_set\trescue_ratio\tself_consistency_ratio\treproducibility" > /srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R1_treated/out/qc/IDR_final.qc

# SYS command. line 210

 echo -e "122131\t94891	91445	""123523\trep1-rep2\tpooled_pseudo_rep\t1.0113975976615275\t1.0376838536825415\t1" >> /srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R1_treated/out/qc/IDR_final.qc
