...
# SYS command. line 51
 ...
 python3 $(which detect_adapter.py) /srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R1_treated/H9_Fucci_LateG1_D2_S30_L004_R2_001.fastq.gz > /srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R1_treated/out/qc/rep2/H9_Fucci_LateG1_D2_S30_L004_R2_001.adapter.txt
