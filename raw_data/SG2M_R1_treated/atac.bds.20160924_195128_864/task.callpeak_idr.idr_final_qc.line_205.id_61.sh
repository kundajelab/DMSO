...
# SYS command. line 209
 ...
 echo -e "Nt\tN1	N2	""Np\tconservative_set\toptimal_set\trescue_ratio\tself_consistency_ratio\treproducibility" > /srv/gsfs0/projects/kundaje/users/annashch/dmso/SG2M_R1_treated/out/qc/IDR_final.qc

# SYS command. line 210

 echo -e "130971\t97810	113210	""134250\trep1-rep2\tpooled_pseudo_rep\t1.0250360766887325\t1.1574481136898067\t1" >> /srv/gsfs0/projects/kundaje/users/annashch/dmso/SG2M_R1_treated/out/qc/IDR_final.qc
