...
# SYS command. line 51
 ...
 python3 $(which detect_adapter.py) /srv/gsfs0/projects/kundaje/users/annashch/dmso/SG2M_R1_treated/H9_Fucci_SG2M_D1_S33_L004_R1_001.fastq.gz > /srv/gsfs0/projects/kundaje/users/annashch/dmso/SG2M_R1_treated/out/qc/rep1/H9_Fucci_SG2M_D1_S33_L004_R1_001.adapter.txt
