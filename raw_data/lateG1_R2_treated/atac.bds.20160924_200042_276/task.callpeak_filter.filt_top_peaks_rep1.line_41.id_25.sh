...
# SYS command. line 49
 ...
 zcat /srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R2_treated/out/peak/macs2/rep1/H9_Fucci_LateG1_R2_D1_S41_L005_R1_001.trim.PE2SE.nodup.tn5.pf.pval0.1.narrowPeak.gz | sort -grk8 | head -n 500000 | gzip -c > /srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R2_treated/out/peak/macs2/rep1/H9_Fucci_LateG1_R2_D1_S41_L005_R1_001.trim.PE2SE.nodup.tn5.pf.pval0.1.500K.narrowPeak.gz
