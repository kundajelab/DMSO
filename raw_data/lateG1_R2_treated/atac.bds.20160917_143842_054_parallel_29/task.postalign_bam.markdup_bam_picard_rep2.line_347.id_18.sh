...
# SYS command. line 368
 ...
 if [ -f "${MARKDUP}" ]; then \
			java -Xmx4G -jar ${MARKDUP} \
				INPUT="/srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R2_treated/out/align/rep2/H9_Fucci_LateG1_R2_D2_S42_L005_R1_001.trim.PE2SE.filt.bam" OUTPUT="/srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R2_treated/out/align/rep2/H9_Fucci_LateG1_R2_D2_S42_L005_R1_001.trim.PE2SE.dupmark.bam" \
				METRICS_FILE="/srv/gsfs0/projects/kundaje/users/annashch/dmso/lateG1_R2_treated/out/qc/rep2/H9_Fucci_LateG1_R2_D2_S42_L005_R1_001.trim.PE2SE.dup.qc" VALIDATION_STRINGENCY=LENIENT \
