...
# SYS command. line 368
 ...
 if [ -f "${MARKDUP}" ]; then \
			java -Xmx4G -jar ${MARKDUP} \
				INPUT="/srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R1_treated/out/align/rep1/H9_Fucci_earlyG1_D1_S25_L004_R1_001.trim.PE2SE.filt.bam" OUTPUT="/srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R1_treated/out/align/rep1/H9_Fucci_earlyG1_D1_S25_L004_R1_001.trim.PE2SE.dupmark.bam" \
				METRICS_FILE="/srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R1_treated/out/qc/rep1/H9_Fucci_earlyG1_D1_S25_L004_R1_001.trim.PE2SE.dup.qc" VALIDATION_STRINGENCY=LENIENT \
