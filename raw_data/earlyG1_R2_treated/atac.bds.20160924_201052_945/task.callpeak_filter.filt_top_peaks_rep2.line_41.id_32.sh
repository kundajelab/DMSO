...
# SYS command. line 49
 ...
 zcat /srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R2_treated/out/peak/macs2/rep2/H9_Fucci_earlyG1_R2_D2_S38_L005_R1_001.trim.PE2SE.nodup.tn5.pf.pval0.1.gappedPeak.gz | sort -grk14 | head -n 500000 | gzip -c > /srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R2_treated/out/peak/macs2/rep2/H9_Fucci_earlyG1_R2_D2_S38_L005_R1_001.trim.PE2SE.nodup.tn5.pf.pval0.1.500K.gappedPeak.gz
