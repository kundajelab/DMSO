...
# SYS command. line 51
 ...
 python3 $(which detect_adapter.py) /srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R2_treated/H9_Fucci_earlyG1_R2_D2_S38_L005_R2_001.fastq.gz > /srv/gsfs0/projects/kundaje/users/annashch/dmso/earlyG1_R2_treated/out/qc/rep2/H9_Fucci_earlyG1_R2_D2_S38_L005_R2_001.adapter.txt
