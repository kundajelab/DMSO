python generate_circos_input.py --pathway_to_gene earlyG1.up.table.txt \
       ...
       --gene_coords gene_coords.txt \
       --outf earlyG1.up.circos


python generate_circos_input.py --pathway_to_gene earlyG1.down.table.txt \
       --gene_to_peak predicted_impact_scores.earlyG1.down.motifs.txt \
       --chrom_hmm_state_map state_map.txt \
       --chrom_hmm_annotation earlyG1.down.chrom_states.bed.filtered \
       --gene_coords gene_coords.txt \
       --outf earlyG1.down.circos

python generate_circos_input.py --pathway_to_gene lateG1.up.table.txt \
       --gene_to_peak predicted_impact_scores.lateG1.up.motifs.txt \
       --chrom_hmm_state_map state_map.txt \
       --chrom_hmm_annotation lateG1.up.chrom_states.bed.filtered \
       --gene_coords gene_coords.txt \
       --outf lateG1.up.circos


python generate_circos_input.py --pathway_to_gene lateG1.down.table.txt \
       --gene_to_peak predicted_impact_scores.lateG1.down.motifs.txt \
       --chrom_hmm_state_map state_map.txt \
       --chrom_hmm_annotation lateG1.down.chrom_states.bed.filtered \
       --gene_coords gene_coords.txt \
       --outf lateG1.down.circos


python generate_circos_input.py --pathway_to_gene SG2M.up.table.txt \
